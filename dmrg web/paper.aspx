<%@ Page Language="VB" AutoEventWireup="false" CodeFile="paper.aspx.vb" Inherits="paper" %>
...
<div id="main">
 <uc1:top ID="top2" runat="server" />
    ...
    <div id="content">
            ...
            <div style="background: #0099CC; color: #FFFFFF; font-family:Simhei, Verdana; font-size: 15px;">研討會論文</div>
