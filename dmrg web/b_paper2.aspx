<%@ Page Language="VB" AutoEventWireup="false" CodeFile="b_paper2.aspx.vb" Inherits="b_paper2" %>
...
<ItemTemplate>
                                  <TR>                                   
                                    <TD ><div align="center"><%#Container.DataItem("主題")%></div></TD>
                                    <TD ><div align="center"><%#Container.DataItem("期刊")%></div></TD>
                                    <TD ><div align="center"><%#Container.DataItem("作者")%></div></TD>
...
<div>
        ...
        <br />
        <asp:Button ID="Button2" runat="server" Text="新增研討會論文" />
    </div>
     <div>
