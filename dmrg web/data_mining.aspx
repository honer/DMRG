<%@ Page Language="VB" AutoEventWireup="false" CodeFile="data_mining.aspx.vb" Inherits="data_mining" %>
...
<div id="main">
 <uc1:top ID="top2" runat="server" />
    <div id="content">
            ...
            <div style="background: #0099CC; color: #FFFFFF; font-family:Simhei, Verdana; font-size: 15px;">資料探勘介紹</div>
 <div style="padding:5px 5px 5px 5px;"><asp:Label ID="Label1" runat="server" Text=""></asp:Label></div>
